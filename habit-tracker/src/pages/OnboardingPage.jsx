...
import { getCurrentPlan, getMaxHabits } from '../utils/planUtils';
...
const OnboardingPage = () => {
  ...
  const handleComplete = async (addSuggested = true) => {
          ...
          >
            ...
            {getCurrentPlan() === 'free' && (
              <div style={{
                ...
                <strong style={{ display: 'block', marginBottom: '6px' }}>Free Plan Limits:</strong>
                <ul style={{ margin: 0, paddingLeft: '16px' }}>
                  <li>Up to 3 habits</li>
                  <li>7 days history</li>
                  <li>5 template packs</li>
      ...
      case 3:
        return (
          ...
          >
            ...
            {getCurrentPlan() === 'free' && (
              <p style={{ textAlign: 'center', marginTop: '24px', color: '#854F0B', fontSize: '14px', fontWeight: 500 }}>
                ⚠️ Free plan limited to 3 habits. Select up to 3.
              </p>
            )}
