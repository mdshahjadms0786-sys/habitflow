  ...
  if (!hasFeature('dreamDiary')) {
    return (
      <div style={{
        ...
        <h2 style={{ marginBottom: '8px' }}>Elite Feature</h2>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '24px', maxWidth: '320px' }}>
          Dream Diary is an Elite exclusive feature. Upgrade to Elite to access morning and evening reflection prompts.
        </p>
        <button
