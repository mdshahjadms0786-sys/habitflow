...
import { getCurrentPlan, isPro, isElite, getMaxHabits, hasFeature } from '../utils/planUtils';
          ...
          {isFree && (
            ...
            >
              ...
              <p style={{
                ...
                AI Coach • Focus Mode • Mood Tracking • Weather • Quests
              </p>
              <button
                onClick={() => navigate('/upgrade')}
                style={{
