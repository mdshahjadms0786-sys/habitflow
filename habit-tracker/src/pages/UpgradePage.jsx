...
const UpgradePage = () => {
  ...
  const handleSelectPlan = (planId) => {
    ...
    if (!user) {
      toast.error('Please log in before upgrading your plan.');
      navigate('/login');
      return;
    }

    // Determine Amount based on plan
    const amount = planId === 'pro' ? 199 : 499;
    const planName = planId === 'pro' ? 'HabitFlow Pro' : 'HabitFlow Elite';
      ...
      <div style={{
        ...
        >
          ...
          <ul style={{
            ...
            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.95rem' }}>
              ✅ <strong>1.25× Points Multiplier</strong> ⚡
            </li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.95rem' }}>
        ...
        >
          ...
          <ul style={{
            ...
            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.95rem' }}>
              ✅ <strong>1.75× Points Multiplier</strong> ⚡
            </li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.95rem' }}>
