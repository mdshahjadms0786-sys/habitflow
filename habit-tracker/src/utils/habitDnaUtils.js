export const calculateHabitDNA = (habits = [], completionLog = {}) => {
  ...
  let TIMING = { label: 'Flexible', emoji: '⚡', score: 50 };
  let CONSISTENCY = { label: 'Work in Progress', emoji: '🔧', score: 30 };
  let FOCUS = { label: 'All-Rounder', emoji: '⚖️', score: 50 };
  let INTENSITY = { label: 'Smart Optimizer', emoji: '🧠', score: 50 };
