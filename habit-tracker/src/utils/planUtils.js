...
export const ELITE_HABIT_PACKS = [
  {
    ...
    difficulty: 'extreme',
    habits: [
      { name: '5 AM Wake Up', icon: '⏰', category: 'Personal', difficulty: 'extreme', points: 100, notes: 'Start day at dawn' },
      { name: 'Cold Plunge 3 Min', icon: '🥶', category: 'Health', difficulty: 'extreme', points: 100, notes: 'Ice bath discipline' },
      { name: '90 Min Deep Work', icon: '🧠', category: 'Work', difficulty: 'extreme', points: 100, notes: 'Deep focus session' },
      { name: 'No Meetings Before 12', icon: '🚫', category: 'Work', difficulty: 'hard', points: 50, notes: 'Protect morning focus' },
      { name: 'Evening Metrics Review', icon: '📊', category: 'Work', difficulty: 'medium', points: 25, notes: 'Review daily KPIs' },
    ],
  },
  {
    id: 42,
    ...
    difficulty: 'extreme',
    habits: [
      { name: '4 AM Wake Up', icon: '⏰', category: 'Personal', difficulty: 'extreme', points: 100, notes: 'Early riser' },
      { name: '2 Hour Workout', icon: '🏋️', category: 'Fitness', difficulty: 'extreme', points: 100, notes: 'Full body training' },
      { name: 'Cold Shower Extreme', icon: '🚿', category: 'Health', difficulty: 'extreme', points: 100, notes: 'Build mental toughness' },
      { name: 'Mental Toughness Drill', icon: '🧠', category: 'Personal', difficulty: 'hard', points: 50, notes: 'Push limits' },
      { name: 'Evening Debrief Journal', icon: '📓', category: 'Personal', difficulty: 'medium', points: 25, notes: 'Review and reflect' },
    ],
  },
  {
    id: 43,
    ...
    difficulty: 'hard',
    habits: [
      { name: 'Read 2 Hours Daily', icon: '📚', category: 'Learning', difficulty: 'hard', points: 50, notes: 'Expand knowledge' },
      { name: 'Network One Person', icon: '🤝', category: 'Work', difficulty: 'medium', points: 25, notes: 'Build connections' },
      { name: 'Review Investments', icon: '📈', category: 'Personal', difficulty: 'easy', points: 10, notes: 'Check portfolio' },
      { name: 'Learn One New Skill', icon: '🎯', category: 'Learning', difficulty: 'hard', points: 50, notes: 'Stay ahead' },
      { name: 'Visualization Practice', icon: '🧘', category: 'Personal', difficulty: 'easy', points: 10, notes: 'See your success' },
    ],
  },
  {
    id: 44,
    ...
    difficulty: 'hard',
    habits: [
      { name: 'Zone 2 Cardio 45min', icon: '🏃', category: 'Fitness', difficulty: 'hard', points: 50, notes: 'Aerobic base' },
      { name: 'Strength Training', icon: '🏋️', category: 'Fitness', difficulty: 'hard', points: 50, notes: 'Build muscle' },
      { name: '8 Hour Sleep Strict', icon: '😴', category: 'Health', difficulty: 'extreme', points: 100, notes: 'Prioritize rest' },
      { name: 'Supplement Protocol', icon: '💊', category: 'Health', difficulty: 'easy', points: 10, notes: 'Take supplements' },
      { name: 'Stress Measurement', icon: '📊', category: 'Health', difficulty: 'easy', points: 10, notes: 'Track stress levels' },
    ],
  },
  {
    id: 45,
    ...
    difficulty: 'extreme',
    habits: [
      { name: 'Morning + Evening Workout', icon: '🏋️', category: 'Fitness', difficulty: 'extreme', points: 100, notes: 'Double training' },
      { name: 'Precise Nutrition Tracking', icon: '🥗', category: 'Health', difficulty: 'hard', points: 50, notes: 'Track every meal' },
      { name: 'Recovery Protocol', icon: '💆', category: 'Health', difficulty: 'medium', points: 25, notes: 'Active recovery' },
      { name: 'Mental Performance Drill', icon: '🧠', category: 'Personal', difficulty: 'hard', points: 50, notes: 'Cognitive training' },
      { name: 'Competition Visualization', icon: '🎯', category: 'Personal', difficulty: 'medium', points: 25, notes: 'See yourself win' },
    ],
  },
];
